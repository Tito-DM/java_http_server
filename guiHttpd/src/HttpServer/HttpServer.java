...
public class HttpServer extends javax.swing.JFrame implements Log {
    public final static  String server_name= "HTTP SAR 2021/2022 by ?????/?????/?????";
    ...
    private void initComponents() {
        ...
        setTitle("HTTP SAR 2021/2022 by ?????/?????/?????");
        setAlwaysOnTop(true);
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(550, 35));
        ...
        jTextRaizHtml.setText("/home/pyong/Documents/SAR/rit2_t1_students_api/html/");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        if (jToggleButton1.isSelected ()) {
            ...
            int port; //HTTp port
            try {
                port= Integer.parseInt (jTextPorto.getText ());
            ...
            main_sthread= new SHttpd( this, serverS);
            n_threads= 0;
            jTextThreads.setText ("0");
...
//            System.out.println("TMfactory default alg.: "+tmf.getDefaultAlgorithm());
    ...
    public static void main (String args[]) {
        new HttpServer ().setVisible(true);
    }
